...
mod graphics;
#[cfg(feature = "graphics")]
pub use self::graphics::Display2in7bc;

/// Epd2in7b driver
pub struct Epd2in7bc<SPI, CS, BUSY, DC, RST, DELAY> {
...
impl<SPI, CS, BUSY, DC, RST, DELAY> InternalWiAdditions<SPI, CS, BUSY, DC, RST, DELAY>
    for Epd2in7bc<SPI, CS, BUSY, DC, RST, DELAY>
where
    SPI: Write<u8>,
    CS: OutputPin,
    BUSY: InputPin,
    ...
    DELAY: DelayMs<u8>,
{
    ...
    fn new(
        ...
        let mut epd = Epd2in7bc { interface, color };
...
impl<SPI, CS, BUSY, DC, RST, DELAY> Epd2in7bc<SPI, CS, BUSY, DC, RST, DELAY>
where
    SPI: Write<u8>,
    CS: OutputPin,
    BUSY: InputPin,
